	...
	return (
		<div>
			...
			<div className='second container h-screen max-w-md justify-center md:hidden'>
				...
				<div className='body ticket container h-3/5 w-full py-3 flex justify-center items-center'>
					<div className='container h-full w-80 overflow-auto overscroll-auto flex justify-center'>
																...
																<div className='container h-4/6 w-full flex items-center justify-center'>
																	<div className='container h-full w-40 overflow-hidden'>
																		<p className='text-xxxs text-justify text-white'>
																			...
																			membuat suatu program di komputer yang
																			dapat berupa software, website, aplikasi,
																			dan lain sebagainya. Proses ini melibatkan
																			beberapa tahap pemrograman, mulai dari
																			tulis menulis, menguji, merevisi, dan
																			mengevaluasi, serta mengujinya lagi sampai
																			program tersebut benar-benar sesuai dengan
																			apa yang diinginkan oleh seorang
																			programmer. Pada perlombaan Programming,
																			biasanya kita akan dihadapi dengan
																			permasalahan IT yang akan menguji
																			kemampuan dan nalar kita untuk dapat
